...
`)}const gy={[of]:"Linear",[af]:"Reinhard",[lf]:"Cineon",[cf]:"ACESFilmic",[uf]:"AgX",[df]:"Neutral",[hf]:"Custom"};function xy(i,t){const e=gy[t];return e===void 0?(Gt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const zo=new N;function _y(){te.getLuminanceCoefficients(zo);const i=zo.x.toFixed(4),t=zo.y.toFixed(4),e=zo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
