var wp=Object.defineProperty;var Tp=(i,t,e)=>t in i?wp(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var $h=(i,t,e)=>(Tp(i,typeof t!="symbol"?t+"":t,e),e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function e(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(s){if(s.ep)return;s.ep=!0;const r=e(s);fetch(s.href,r)}})();const Cp="modulepreload",Pp=function(i){return"/"+i},qh={},Zh=function(t,e,n){if(!e||e.length===0)return t();const s=document.getElementsByTagName("link");return Promise.all(e.map(r=>{if(r=Pp(r),r in qh)return;qh[r]=!0;const o=r.endsWith(".css"),a=o?'[rel="stylesheet"]':"";if(!!n)for(let h=s.length-1;h>=0;h--){const u=s[h];if(u.href===r&&(!o||u.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${r}"]${a}`))return;const c=document.createElement("link");if(c.rel=o?"stylesheet":Cp,o||(c.as="script",c.crossOrigin=""),c.href=r,document.head.appendChild(c),o)return new Promise((h,u)=>{c.addEventListener("load",h),c.addEventListener("error",()=>u(new Error(`Unable to preload CSS for ${r}`)))})})).then(()=>t()).catch(r=>{const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=r,window.dispatchEvent(o),!o.defaultPrevented)throw r})};function Aa(i){return i*Math.PI/180}function me(i){if(!i||typeof i!="string")return i;try{return math.evaluate(i)}catch{return i}}function Rp(i){var r;if(!i||i.length===0)return{minX:0,minY:0,maxX:0,maxY:0,width:0,height:0,center:{x:0,y:0}};const t=(r=i[0])==null?void 0:r.ownerSVGElement;if(!t)return{minX:0,minY:0,maxX:0,maxY:0,width:0,height:0,center:{x:0,y:0}};const e=t.getAttribute("viewBox"),n=t.getBoundingClientRect();t.setAttribute("viewBox",`0 0 ${n.width} ${n.height}`);try{let o=function(g){const x=g.getBBox(),m=g.getCTM(),p=t.createSVGPoint(),y=[{x:x.x,y:x.y},{x:x.x+x.width,y:x.y},{x:x.x+x.width,y:x.y+x.height},{x:x.x,y:x.y+x.height}];let _=1/0,v=1/0,S=-1/0,A=-1/0;return y.forEach(M=>{p.x=M.x,p.y=M.y;const T=p.matrixTransform(m);_=Math.min(_,T.x),v=Math.min(v,T.y),S=Math.max(S,T.x),A=Math.max(A,T.y)}),{x:_,y:v,width:S-_,height:A-v}};var s=o;let a=1/0,l=1/0,c=-1/0,h=-1/0;if(i.forEach(g=>{if(g&&typeof g.getBBox=="function"){const x=o(g);a=Math.min(a,x.x),l=Math.min(l,x.y),c=Math.max(c,x.x+x.width),h=Math.max(h,x.y+x.height)}}),a===1/0)return{minX:0,minY:0,maxX:0,maxY:0,width:0,height:0,center:{x:0,y:0}};const u=c-a,d=h-l,f={x:a+u/2,y:l+d/2};return{minX:a,minY:l,maxX:c,maxY:h,width:u,height:d,center:f}}finally{e?t.setAttribute("viewBox",e):t.removeAttribute("viewBox")}}function Lp(i,t,e=0){const{width:n,height:s}=t,r=n+2*e,o=s+2*e,a=i.canvas.getBoundingClientRect(),l=a.width,c=a.height,h=l/r,u=c/o;i.zoomLevel=Math.min(h,u),i.panX=t.center.x,i.panY=t.center.y,i.updateViewBox(),i.canvas.style.transition="viewBox 1s ease"}function ef(i,t){if(t){const{minX:e,maxX:n,minY:s,maxY:r,padding:o=20}=t,a=n-e+2*o,l=r-s+2*o,c=i.canvas.getBoundingClientRect(),h=c.width,u=c.height,d=h/a,f=u/l;i.zoomLevel=Math.min(d,f),i.panX=(e+n)/2,i.panY=(s+r)/2}else{const e=i.canvas.getBoundingClientRect();i.zoomLevel=1,i.panX=e.width/2,i.panY=e.height/2}i.updateViewBox()}function Dp(i,t,e=20){const n=ec(t);ef(i,{minX:n.centerX-n.width/2,maxX:n.centerX+n.width/2,minY:n.centerY-n.height/2,maxY:n.centerY+n.height/2,padding:e})}function ec(i){const t=document.createElementNS("http://www.w3.org/2000/svg","svg");t.style.position="absolute",t.style.left="-9999px",t.style.top="-9999px",t.style.width="1px",t.style.height="1px",t.appendChild(i),document.body.appendChild(t);const e=i.getBBox();return document.body.removeChild(t),{width:e.width,height:e.height,centerX:e.x+e.width/2,centerY:e.y+e.height/2}}const vs={cylindrical:{operations:["AL","OU","IN"],bits:[{id:"cyl-1",name:"D10H20",diameter:10,length:20,shankDiameter:6,totalLength:50,fillColor:"rgba(0, 140, 255, 0.3)"},{id:"cyl-2",name:"D12H25",diameter:12,length:25,shankDiameter:8,totalLength:60,fillColor:"rgba(0, 140, 255, 0.3)"}]},conical:{operations:["AL","VC"],bits:[{id:"con-1",name:"V90D25",diameter:25.4,length:19,angle:90,fillColor:"rgba(26, 255, 0, 0.3)"},{id:"con-2",name:"V120D32",diameter:32,length:13.2,angle:120,fillColor:"rgba(26, 255, 0, 0.3)"},{id:"con-3",name:"V120D50",diameter:50,length:20.6,angle:120,fillColor:"rgba(26, 255, 0, 0.3)"}]},ball:{operations:["AL","OU","IN"],bits:[{id:"bn-1",name:"U10",diameter:10,length:20,height:5,fillColor:"rgba(255, 0, 0, 0.3)"},{id:"bn-2",name:"U19",diameter:19,length:25,height:9.5,fillColor:"rgba(255, 0, 0, 0.3)"},{id:"bn-3",name:"U38",diameter:38.1,length:22,height:19.05,fillColor:"rgba(255, 0, 0, 0.3)"}]},fillet:{operations:["AL","OU","IN"],bits:[{id:"fil-1",name:"R3",diameter:6.35,length:6.35,height:3.175,cornerRadius:3.175,flat:0,fillColor:"rgba(128, 0, 128, 0.3)"},{id:"fil-2",name:"R4D9F2",diameter:9.5,length:9.5,height:4,cornerRadius:4,flat:2,fillColor:"rgba(128, 0, 128, 0.3)"}]},bull:{operations:["AL","OU","IN"],bits:[{id:"bul-1",name:"B3D10",diameter:10,length:10,height:3,cornerRadius:3,flat:4,fillColor:"rgba(128, 128, 0, 0.3)"},{id:"bul-2",name:"B2D12",diameter:12,length:12,height:2,cornerRadius:2,flat:8,fillColor:"rgba(128, 128, 0, 0.3)"}]}},nf="facade_bits_v1";let le=null;const Na=new Set(Object.keys(vs));function Vr(i){const t=vs[i];return t&&typeof t=="object"&&t.bits?{operations:t.operations||[],bits:t.bits}:{operations:["AL"],bits:t||[]}}function ms(){return"b_"+Date.now().toString(36)+Math.random().toString(36).slice(2,8)}async function ro(){const i=localStorage.getItem(nf);if(i)try{const t=JSON.parse(i);le={};let e=!1;Object.keys(vs).forEach(n=>{t[n]?le[n]=t[n]:(le[n]=Vr(n).bits.map(s=>({id:s.id||ms(),...s})),e=!0)}),e&&Si();return}catch(t){console.warn("Failed to parse bits from storage, fallback to defaults.",t)}try{const t=await fetch("./src/data/userBits.json");if(t.ok){const e=await t.json();le={},Object.keys(vs).forEach(n=>{e[n]&&Array.isArray(e[n])?le[n]=e[n].map(s=>({id:s.id||ms(),...s})):le[n]=Vr(n).bits.map(s=>({id:s.id||ms(),...s}))}),Si();return}}catch(t){console.warn("Failed to load from userBits.json, using defaults.",t)}le={},Object.keys(vs).forEach(t=>{le[t]=Vr(t).bits.map(e=>({id:e.id||ms(),...e}))}),Si()}function Si(){localStorage.setItem(nf,JSON.stringify(le))}let jh=!1,Ya=null;async function Ip(){jh||(Ya||(Ya=ro()),await Ya,jh=!0)}async function gs(){return await Ip(),le}function Np(i){le={},Object.keys(vs).forEach(t=>{le[t]=i[t]||Vr(t).bits.map(e=>({id:e.id||ms(),...e}))}),Si()}function uh(i){return Na.has(i)?Vr(i).operations:[]}function nc(i,t){if(le||ro(),!Na.has(i))return null;const e={id:ms(),...t};return Array.isArray(le[i])||(le[i]=[]),le[i].push(e),Si(),e}function sf(i,t,e){if(le||ro(),!Na.has(i))return null;const n=le[i].findIndex(s=>s.id===t);return n===-1?null:(le[i][n]={...le[i][n],...e},Si(),le[i][n])}function rf(i,t){le||ro(),Na.has(i)&&(le[i]=le[i].filter(e=>e.id!==t),Si())}function Bp(){le=null,ro(),Si()}function Up(){if(!le)return null;const i=JSON.stringify(le,null,2),t=new Blob([i],{type:"application/json"}),e=document.createElement("a");return e.href=URL.createObjectURL(t),e.download="userBits.json",document.body.appendChild(e),e.click(),document.body.removeChild(e),t}function Fp(i){try{const t=JSON.parse(i),e=Object.keys(vs);if(!e.every(s=>Array.isArray(t[s])))throw new Error("Invalid JSON structure");return le={},e.forEach(s=>{le[s]=(t[s]||[]).map(r=>({id:r.id||ms(),...r}))}),Si(),!0}catch(t){return console.error("Failed to import JSON:",t),!1}}const Kh=Object.freeze(Object.defineProperty({__proto__:null,addBit:nc,deleteBit:rf,exportToJSON:Up,getBits:gs,getOperationsForGroup:uh,importFromJSON:Fp,resetToDefaults:Bp,setBits:Np,updateBit:sf},Symbol.toStringTag,{value:"Module"}));class Jh{constructor(t,e,n,s){this.svgNS=t,this.defs=e,this.gridLayer=n,this.config=s}render(){const t=this.defs.querySelector(`#${this.config.id}-pattern`);t&&this.defs.removeChild(t);let e=0,n=0;const s=document.createElementNS(this.svgNS,"pattern");s.id=`${this.config.id}-pattern`,s.setAttribute("patternUnits","userSpaceOnUse"),s.setAttribute("x",e),s.setAttribute("y",n),s.setAttribute("width",this.config.size),s.setAttribute("height",this.config.size);const r=document.createElementNS(this.svgNS,"line");r.setAttribute("x1",0),r.setAttribute("y1",0),r.setAttribute("x2",this.config.size),r.setAttribute("y2",0),r.setAttribute("stroke",this.config.color),r.setAttribute("stroke-width",this.config.thickness),s.appendChild(r);const o=document.createElementNS(this.svgNS,"line");o.setAttribute("x1",0),o.setAttribute("y1",0),o.setAttribute("x2",0),o.setAttribute("y2",this.config.size),o.setAttribute("stroke",this.config.color),o.setAttribute("stroke-width",this.config.thickness),s.appendChild(o),this.defs.appendChild(s);const a=document.createElementNS(this.svgNS,"rect");a.setAttribute("x",this.config.x),a.setAttribute("y",this.config.y),a.setAttribute("width",this.config.width),a.setAttribute("height",this.config.height),a.setAttribute("fill",`url(#${this.config.id}-pattern)`),a.setAttribute("pointer-events","none"),this.gridLayer.appendChild(a)}}class of{constructor(t){this.config={canvas:null,width:800,height:600,enableZoom:!0,enablePan:!0,enableGrid:!0,enableMouseEvents:!0,enableSelection:!1,enableDrag:!1,gridSize:1,gridAnchorX:null,gridAnchorY:null,initialZoom:1,initialPanX:400,initialPanY:300,layers:["grid","content","overlay"],onZoom:null,onPan:null,onMouseDown:null,onMouseMove:null,onMouseUp:null,onWheel:null,...t},this.svgNS="http://www.w3.org/2000/svg",this.zoomLevel=this.config.initialZoom,this.panX=this.config.initialPanX,this.panY=this.config.initialPanY,this.isDragging=!1,this.lastMouseX=0,this.lastMouseY=0,this.gridEnabled=this.config.enableGrid,this.layers={},this.gridLayer=null,this.initialize()}initialize(){if(!this.config.canvas)throw new Error("Canvas element is required");this.canvas=this.config.canvas,this.updateCanvasSize(),this.canvas.setAttribute("width","100%"),this.canvas.setAttribute("height","100%"),this.panX=this.canvasParameters.width/2,this.panY=this.canvasParameters.height/2,this.canvas.setAttribute("viewBox",`0 0 ${this.canvasParameters.width} ${this.canvasParameters.height}`),this.config.layers.forEach(e=>{const n=document.createElementNS(this.svgNS,"g");n.id=`${e}-layer`,this.layers[e]=n,this.canvas.appendChild(n),e==="grid"&&(this.gridLayer=n)}),this.config.enableGrid&&this.drawGrid(),this.config.enableMouseEvents&&this.setupMouseEvents();const t=this.canvas.parentElement;t&&(this.resizeObserver=new ResizeObserver(()=>{this.resize()}),this.resizeObserver.observe(t)),this.updateViewBox()}setupMouseEvents(){this.config.enableZoom&&this.canvas.addEventListener("wheel",this.handleZoom.bind(this),{passive:!1}),this.canvas.addEventListener("mousedown",this.handleMouseDown.bind(this)),this.canvas.addEventListener("mousemove",this.handleMouseMove.bind(this)),this.canvas.addEventListener("mouseup",this.handleMouseUp.bind(this)),this.canvas.addEventListener("mouseleave",this.handleMouseUp.bind(this)),this.setupTouchEvents()}setupTouchEvents(){this.setupBasicTouchEvents()}setupBasicTouchEvents(){const t=this.canvas.parentElement;t&&(t.addEventListener("touchstart",this.handleTouchStart.bind(this),{passive:!1}),t.addEventListener("touchmove",this.handleTouchMove.bind(this),{passive:!1}),t.addEventListener("touchend",this.handleTouchEnd.bind(this),{passive:!1})),this.canvas.addEventListener("touchstart",this.handleTouchStart.bind(this),{passive:!1}),this.canvas.addEventListener("touchmove",this.handleTouchMove.bind(this),{passive:!1}),this.canvas.addEventListener("touchend",this.handleTouchEnd.bind(this),{passive:!1})}drawGrid(){if(!this.gridEnabled||!this.gridLayer)return;this.gridLayer.innerHTML="";let t=this.canvas.querySelector("defs");t||(t=document.createElementNS(this.svgNS,"defs"),this.canvas.insertBefore(t,this.canvas.firstChild));const e=this.canvas.getBoundingClientRect(),n=e.width/this.zoomLevel,s=e.height/this.zoomLevel,r=this.panX-n/2,o=this.panY-s/2;let a=this.config.gridSize;const l=1;a*this.zoomLevel<l&&(a=l/this.zoomLevel);const c=Math.max(.01,.1/Math.sqrt(this.zoomLevel)),h=10,u={id:"grid",size:this.config.gridSize,color:"#e0e0e0",thickness:c,anchorX:this.config.gridAnchorX-this.config.gridSize/2,anchorY:this.config.gridAnchorY-this.config.gridSize/2,panX:this.panX,panY:this.panY,x:r,y:o,width:n,height:s};new Jh(this.svgNS,t,this.gridLayer,u).render();const f={id:"aux-grid",size:h,color:"#5f5959ff",thickness:c*2,anchorX:this.config.gridAnchorX-this.config.gridSize/2,anchorY:this.config.gridAnchorY-this.config.gridSize/2,panX:this.panX,panY:this.panY,x:r,y:o,width:n,height:s};new Jh(this.svgNS,t,this.gridLayer,f).render()}toggleGrid(){this.gridEnabled=!this.gridEnabled,this.gridEnabled?this.drawGrid():this.gridLayer&&(this.gridLayer.innerHTML="")}zoomIn(){this.zoomLevel*=1.2,this.updateViewBox()}zoomOut(){this.zoomLevel/=1.2,this.updateViewBox()}fitToScale(t=null){ef(this,t)}fitToSVGElement(t,e=20){Dp(this,t,e)}updateViewBox(){const t=this.canvas.getBoundingClientRect(),e=t.width/this.zoomLevel,n=t.height/this.zoomLevel,s=this.panX-e/2,r=this.panY-n/2;this.canvas.setAttribute("viewBox",`${s} ${r} ${e} ${n}`),this.gridEnabled&&this.drawGrid(),this.config.onZoom&&this.config.onZoom(this.zoomLevel,this.panX,this.panY)}handleZoom(t){t.preventDefault();const e=this.canvas.getBoundingClientRect(),n=t.clientX-e.left,s=t.clientY-e.top,r=t.deltaY>0?.9:1.1,o=this.zoomLevel;this.zoomLevel*=r;const a=e.width/o,l=e.height/o,c=this.panX-a/2,h=this.panY-l/2,u=c+n/e.width*a,d=h+s/e.height*l,f=e.width/this.zoomLevel,g=e.height/this.zoomLevel,x=u-n/e.width*f,m=d-s/e.height*g;this.panX=x+f/2,this.panY=m+g/2,this.updateViewBox(),this.config.onWheel&&this.config.onWheel(t,this.zoomLevel,this.panX,this.panY)}handleMouseDown(t){t.button===0&&this.config.enablePan&&(this.isDragging=!0,this.lastMouseX=t.clientX,this.lastMouseY=t.clientY,this.canvas.style.cursor="grabbing"),this.config.onMouseDown&&this.config.onMouseDown(t)}handleMouseMove(t){if(this.isDragging&&this.config.enablePan){const e=t.clientX-this.lastMouseX,n=t.clientY-this.lastMouseY,s=e/this.zoomLevel,r=n/this.zoomLevel;this.panX-=s,this.panY-=r,this.lastMouseX=t.clientX,this.lastMouseY=t.clientY,this.updateViewBox()}this.config.onMouseMove&&this.config.onMouseMove(t)}handleMouseUp(t){this.isDragging&&(this.isDragging=!1,this.canvas.style.cursor=this.config.enablePan?"grab":"default"),this.config.onMouseUp&&this.config.onMouseUp(t)}handleTouchStart(t){t.touches.length===1&&this.config.enablePan?(t.preventDefault(),this.isDragging=!0,this.lastMouseX=t.touches[0].clientX,this.lastMouseY=t.touches[0].clientY):t.touches.length===2&&this.config.enableZoom&&(t.preventDefault(),this.handlePinchStart(t))}handleTouchMove(t){if(this.isDragging&&t.touches.length===1&&this.config.enablePan){t.preventDefault();const e=t.touches[0].clientX-this.lastMouseX,n=t.touches[0].clientY-this.lastMouseY,s=e/this.zoomLevel,r=n/this.zoomLevel;this.panX-=s,this.panY-=r,this.lastMouseX=t.touches[0].clientX,this.lastMouseY=t.touches[0].clientY,this.updateViewBox()}else t.touches.length===2&&this.config.enableZoom&&(t.preventDefault(),this.handlePinchMove(t))}handleTouchEnd(t){this.isDragging&&(this.isDragging=!1),this.pinchStartDistance&&(this.pinchStartDistance=null,this.pinchStartZoom=null,this.pinchStartCenterX=null,this.pinchStartCenterY=null)}handlePinchStart(t){const e=t.touches[0],n=t.touches[1];this.pinchStartDistance=this.getTouchDistance(e,n),this.pinchStartZoom=this.zoomLevel,this.pinchStartCenterX=(e.clientX+n.clientX)/2,this.pinchStartCenterY=(e.clientY+n.clientY)/2}handlePinchMove(t){const e=t.touches[0],n=t.touches[1],s=this.getTouchDistance(e,n);if(this.pinchStartDistance&&this.pinchStartZoom){const r=s/this.pinchStartDistance;let o=this.pinchStartZoom*r;o=Math.max(.1,Math.min(10,o)),Math.abs(o-this.zoomLevel)>.01&&(this.zoomLevel=o,this.updateViewBox())}}getTouchDistance(t,e){const n=t.clientX-e.clientX,s=t.clientY-e.clientY;return Math.sqrt(n*n+s*s)}screenToSvg(t,e){const n=this.canvas.getBoundingClientRect(),s=t-n.left,r=e-n.top,o=n.width/this.zoomLevel,a=n.height/this.zoomLevel,l=this.panX-o/2,c=this.panY-a/2,h=l+s/n.width*o,u=c+r/n.height*a;return{x:h,y:u}}snapToGrid(t){return Math.round(t/this.config.gridSize)*this.config.gridSize}getLayer(t){return this.layers[t]}clearLayer(t){this.layers[t]&&(this.layers[t].innerHTML="")}addToLayer(t,e){this.layers[t]&&this.layers[t].appendChild(e)}removeFromLayer(t,e){this.layers[t]&&e.parentNode===this.layers[t]&&this.layers[t].removeChild(e)}updateCanvasSize(){var e,n;const t=this.canvas.parentElement;if(t){const s=t.clientWidth,r=t.clientHeight;this.canvasParameters={width:s>0?s:((e=this.canvasParameters)==null?void 0:e.width)||this.config.width||800,height:r>0?r:((n=this.canvasParameters)==null?void 0:n.height)||this.config.height||600}}else this.canvasParameters={width:this.config.width||800,height:this.config.height||600}}resize(){const t=this.canvasParameters.width,e=this.canvasParameters.height;this.updateCanvasSize(),this.panX=this.panX/t*this.canvasParameters.width,this.panY=this.panY/e*this.canvasParameters.height,this.updateViewBox()}}const we="http://www.w3.org/2000/svg";class ic{constructor(t){this.canvasManager=t,this.bitGroups=document.getElementById("bit-groups")}createSVGIcon(t,e,n=50){const s=document.createElementNS(we,"svg");s.setAttribute("width",n),s.setAttribute("height",n),s.setAttribute("viewBox",`0 0 ${n} ${n}`);const r=document.createElementNS(we,"circle");r.setAttribute("cx",n/2),r.setAttribute("cy",n/2),r.setAttribute("r",n/2-1),r.setAttribute("fill","white"),r.setAttribute("stroke","black"),r.setAttribute("stroke-width","2"),s.appendChild(r);const o=document.createElementNS(we,"g");o.setAttribute("transform",`translate(${n/2}, ${n/2})`);let a;if(t!=="newBit"&&e&&e.diameter!==void 0)a=this.createBitShapeElement(e,t,0,e.length/2,!1,!1),a.setAttribute("transform",`scale(${n/80})`);else{const l=n/4;switch(t){case"cylindrical":a=document.createElementNS(we,"rect"),a.setAttribute("x",-n/4),a.setAttribute("y",-n/4),a.setAttribute("width",n/2),a.setAttribute("height",n/2);break;case"conical":a=document.createElementNS(we,"path"),a.setAttribute("d",`M ${-l} 0
  ...
  `,document.body.appendChild(x);const m=x.querySelector("#bit-form");let p,y=!1;const _=()=>{p=new of({canvas:x.querySelector("#bit-preview-canvas"),width:200,height:200,enableZoom:!0,enablePan:!0,enableGrid:!0,enableMouseEvents:!0,gridSize:10,initialZoom:1,initialPanX:100,initialPanY:100,layers:["grid","bits"],onZoom:F=>{T(F)}})},v=()=>{p.zoomIn(),b()},S=()=>{p.zoomOut(),b()},A=()=>{if(this.validateBitParameters(m,t)){const F=this.collectBitParameters(m,t),V=this.createBitShapeElement(F,t,0,0,!0);ec(V),p.fitToSVGElement(V,5)}else p.zoomLevel=1,p.panX=100,p.panY=100,p.updateViewBox();T(),b()},M=()=>{p.toggleGrid()};_();function T(F=p==null?void 0:p.zoomLevel){if(!F||!p)return;const V=Math.max(.1,.5/Math.sqrt(F)),G=p.getLayer("bits"),k=G==null?void 0:G.querySelector(".bit-shape"),X=G==null?void 0:G.querySelector(".shank-shape");k&&k.setAttribute("stroke-width",V),X&&X.setAttribute("stroke-width",V)}const b=()=>{const F=p.getLayer("bits");if(F.innerHTML="",!this.validateBitParameters(m,t)){const st=document.createElementNS(we,"text");st.setAttribute("x",p.panX),st.setAttribute("y",p.panY+10),st.setAttribute("text-anchor","middle"),st.setAttribute("font-size","14"),st.setAttribute("fill","#999"),st.textContent="Заполните все параметры",F.appendChild(st);return}const V=this.collectBitParameters(m,t),G=this.createBitShapeElement(V,t,0,0,!0),k=ec(G);if(!y){const Ot=160/k.width,Ht=160/k.height,Z=Math.min(Ot,Ht);p.zoomLevel=Z,p.updateViewBox(),y=!0}const X=Math.max(.1,.5/Math.sqrt(p.zoomLevel)),ht=this.createBitShapeElement(V,t,p.panX-k.centerX,p.panY-k.centerY,!0,!0,X);F.appendChild(ht)};if(x.querySelector("#preview-zoom-in").addEventListener("click",()=>{v(),b()}),x.querySelector("#preview-zoom-out").addEventListener("click",()=>{S(),b()}),x.querySelector("#preview-fit").addEventListener("click",()=>{A()}),x.querySelector("#preview-toggle-grid").addEventListener("click",()=>{M()}),m.querySelectorAll('input[type="text"]').forEach(F=>{F.addEventListener("blur",()=>{F.value=me(F.value)}),F.addEventListener("input",b)}),m.querySelectorAll('input[type="number"]').forEach(F=>{F.addEventListener("input",b),A()}),x.querySelector("#bit-color").addEventListener("input",b),n&&e){const F=()=>{const k=this.collectBitParameters(m,t);this.onUpdateCanvasBitWithParams&&this.onUpdateCanvasBitWithParams(e.id,k,t)},V=m.querySelectorAll('input[type="text"], input[type="number"]'),G=x.querySelector("#bit-color");V.forEach(k=>{k.addEventListener("input",F)}),G&&G.addEventListener("input",F)}b(),A(),m.addEventListener("submit",async F=>{F.preventDefault();const V=m.querySelector("#bit-name").value.trim();if(await this.isBitNameDuplicate(V,n?e==null?void 0:e.id:null)){alert("A bit with this name already exists. Please choose a different name.");return}const G=this.buildBitPayload(m,t);let k;n?k=sf(t,e.id,G):k=nc(t,G),n&&this.updateCanvasBitsForBitId(k.id),document.body.removeChild(x),this.refreshBitGroups()}),x.querySelector("#cancel-btn").addEventListener("click",()=>{document.body.removeChild(x)})}getGroupSpecificInputs(t,e={}){const n=e.diameter!==void 0?e.diameter:"",s=e.length!==void 0?e.length:"",r=e.angle!==void 0?e.angle:"",o=e.height!==void 0?e.height:"",a=e.cornerRadius!==void 0?e.cornerRadius:"",l=e.flat!==void 0?e.flat:"",c=e.shankDiameter!==void 0?e.shankDiameter:"",h=e.totalLength!==void 0?e.totalLength:"";let u=`
...
void main() {
	...
	#include <colorspace_fragment>
	#include <fog_fragment>
}`,Kt={alphahash_fragment:A0,alphahash_pars_fragment:w0,alphamap_fragment:T0,alphamap_pars_fragment:C0,alphatest_fragment:P0,alphatest_pars_fragment:R0,aomap_fragment:L0,aomap_pars_fragment:D0,batching_pars_vertex:I0,batching_vertex:N0,begin_vertex:B0,beginnormal_vertex:U0,bsdfs:F0,iridescence_fragment:O0,bumpmap_pars_fragment:k0,clipping_planes_fragment:z0,clipping_planes_pars_fragment:V0,clipping_planes_pars_vertex:G0,clipping_planes_vertex:H0,color_fragment:W0,color_pars_fragment:X0,color_pars_vertex:Y0,color_vertex:$0,common:q0,cube_uv_reflection_fragment:Z0,defaultnormal_vertex:j0,displacementmap_pars_vertex:K0,displacementmap_vertex:J0,emissivemap_fragment:Q0,emissivemap_pars_fragment:tx,colorspace_fragment:ex,colorspace_pars_fragment:nx,envmap_fragment:ix,envmap_common_pars_fragment:sx,envmap_pars_fragment:rx,envmap_pars_vertex:ox,envmap_physical_pars_fragment:xx,envmap_vertex:ax,fog_vertex:lx,fog_pars_vertex:cx,fog_fragment:hx,fog_pars_fragment:ux,gradientmap_pars_fragment:dx,lightmap_pars_fragment:fx,lights_lambert_fragment:px,lights_lambert_pars_fragment:mx,lights_pars_begin:gx,lights_toon_fragment:_x,lights_toon_pars_fragment:vx,lights_phong_fragment:yx,lights_phong_pars_fragment:Sx,lights_physical_fragment:bx,lights_physical_pars_fragment:Mx,lights_fragment_begin:Ex,lights_fragment_maps:Ax,lights_fragment_end:wx,logdepthbuf_fragment:Tx,logdepthbuf_pars_fragment:Cx,logdepthbuf_pars_vertex:Px,logdepthbuf_vertex:Rx,map_fragment:Lx,map_pars_fragment:Dx,map_particle_fragment:Ix,map_particle_pars_fragment:Nx,metalnessmap_fragment:Bx,metalnessmap_pars_fragment:Ux,morphinstance_vertex:Fx,morphcolor_vertex:Ox,morphnormal_vertex:kx,morphtarget_pars_vertex:zx,morphtarget_vertex:Vx,normal_fragment_begin:Gx,normal_fragment_maps:Hx,normal_pars_fragment:Wx,normal_pars_vertex:Xx,normal_vertex:Yx,normalmap_pars_fragment:$x,clearcoat_normal_fragment_begin:qx,clearcoat_normal_fragment_maps:Zx,clearcoat_pars_fragment:jx,iridescence_pars_fragment:Kx,opaque_fragment:Jx,packing:Qx,premultiplied_alpha_fragment:t_,project_vertex:e_,dithering_fragment:n_,dithering_pars_fragment:i_,roughnessmap_fragment:s_,roughnessmap_pars_fragment:r_,shadowmap_pars_fragment:o_,shadowmap_pars_vertex:a_,shadowmap_vertex:l_,shadowmask_pars_fragment:c_,skinbase_vertex:h_,skinning_pars_vertex:u_,skinning_vertex:d_,skinnormal_vertex:f_,specularmap_fragment:p_,specularmap_pars_fragment:m_,tonemapping_fragment:g_,tonemapping_pars_fragment:x_,transmission_fragment:__,transmission_pars_fragment:v_,uv_pars_fragment:y_,uv_pars_vertex:S_,uv_vertex:b_,worldpos_vertex:M_,background_vert:E_,background_frag:A_,backgroundCube_vert:w_,backgroundCube_frag:T_,cube_vert:C_,cube_frag:P_,depth_vert:R_,depth_frag:L_,distance_vert:D_,distance_frag:I_,equirect_vert:N_,equirect_frag:B_,linedashed_vert:U_,linedashed_frag:F_,meshbasic_vert:O_,meshbasic_frag:k_,meshlambert_vert:z_,meshlambert_frag:V_,meshmatcap_vert:G_,meshmatcap_frag:H_,meshnormal_vert:W_,meshnormal_frag:X_,meshphong_vert:Y_,meshphong_frag:$_,meshphysical_vert:q_,meshphysical_frag:Z_,meshtoon_vert:j_,meshtoon_frag:K_,points_vert:J_,points_frag:Q_,shadow_vert:tv,shadow_frag:ev,sprite_vert:nv,sprite_frag:iv},Et={common:{diffuse:{value:new $t(16777215)},opacity:{value:1},map:{value:null},mapTransform:{value:new Xt},alphaMap:{value:null},alphaMapTransform:{value:new Xt},alphaTest:{value:0}},specularmap:{specularMap:{value:null},specularMapTransform:{value:new Xt}},envmap:{envMap:{value:null},envMapRotation:{value:new Xt},flipEnvMap:{value:-1},reflectivity:{value:1},ior:{value:1.5},refractionRatio:{value:.98},dfgLUT:{value:null}},aomap:{aoMap:{value:null},aoMapIntensity:{value:1},aoMapTransform:{value:new Xt}},lightmap:{lightMap:{value:null},lightMapIntensity:{value:1},lightMapTransform:{value:new Xt}},bumpmap:{bumpMap:{value:null},bumpMapTransform:{value:new Xt},bumpScale:{value:1}},normalmap:{normalMap:{value:null},normalMapTransform:{value:new Xt},normalScale:{value:new it(1,1)}},displacementmap:{displacementMap:{value:null},displacementMapTransform:{value:new Xt},displacementScale:{value:1},displacementBias:{value:0}},emissivemap:{emissiveMap:{value:null},emissiveMapTransform:{value:new Xt}},metalnessmap:{metalnessMap:{value:null},metalnessMapTransform:{value:new Xt}},roughnessmap:{roughnessMap:{value:null},roughnessMapTransform:{value:new Xt}},gradientmap:{gradientMap:{value:null}},fog:{fogDensity:{value:25e-5},fogNear:{value:1},fogFar:{value:2e3},fogColor:{value:new $t(16777215)}},lights:{ambientLightColor:{value:[]},lightProbe:{value:[]},directionalLights:{value:[],properties:{direction:{},color:{}}},directionalLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},directionalShadowMap:{value:[]},directionalShadowMatrix:{value:[]},spotLights:{value:[],properties:{color:{},position:{},direction:{},distance:{},coneCos:{},penumbraCos:{},decay:{}}},spotLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},spotLightMap:{value:[]},spotShadowMap:{value:[]},spotLightMatrix:{value:[]},pointLights:{value:[],properties:{color:{},position:{},decay:{},distance:{}}},pointLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{},shadowCameraNear:{},shadowCameraFar:{}}},pointShadowMap:{value:[]},pointShadowMatrix:{value:[]},hemisphereLights:{value:[],properties:{direction:{},skyColor:{},groundColor:{}}},rectAreaLights:{value:[],properties:{color:{},position:{},width:{},height:{}}},ltc_1:{value:null},ltc_2:{value:null}},points:{diffuse:{value:new $t(16777215)},opacity:{value:1},size:{value:1},scale:{value:1},map:{value:null},alphaMap:{value:null},alphaMapTransform:{value:new Xt},alphaTest:{value:0},uvTransform:{value:new Xt}},sprite:{diffuse:{value:new $t(16777215)},opacity:{value:1},center:{value:new it(.5,.5)},rotation:{value:0},map:{value:null},mapTransform:{value:new Xt},alphaMap:{value:null},alphaMapTransform:{value:new Xt},alphaTest:{value:0}}},Kn={basic:{uniforms:en([Et.common,Et.specularmap,Et.envmap,Et.aomap,Et.lightmap,Et.fog]),vertexShader:Kt.meshbasic_vert,fragmentShader:Kt.meshbasic_frag},lambert:{uniforms:en([Et.common,Et.specularmap,Et.envmap,Et.aomap,Et.lightmap,Et.emissivemap,Et.bumpmap,Et.normalmap,Et.displacementmap,Et.fog,Et.lights,{emissive:{value:new $t(0)}}]),vertexShader:Kt.meshlambert_vert,fragmentShader:Kt.meshlambert_frag},phong:{uniforms:en([Et.common,Et.specularmap,Et.envmap,Et.aomap,Et.lightmap,Et.emissivemap,Et.bumpmap,Et.normalmap,Et.displacementmap,Et.fog,Et.lights,{emissive:{value:new $t(0)},specular:{value:new $t(1118481)},shininess:{value:30}}]),vertexShader:Kt.meshphong_vert,fragmentShader:Kt.meshphong_frag},standard:{uniforms:en([Et.common,Et.envmap,Et.aomap,Et.lightmap,Et.emissivemap,Et.bumpmap,Et.normalmap,Et.displacementmap,Et.roughnessmap,Et.metalnessmap,Et.fog,Et.lights,{emissive:{value:new $t(0)},roughness:{value:1},metalness:{value:0},envMapIntensity:{value:1}}]),vertexShader:Kt.meshphysical_vert,fragmentShader:Kt.meshphysical_frag},toon:{uniforms:en([Et.common,Et.aomap,Et.lightmap,Et.emissivemap,Et.bumpmap,Et.normalmap,Et.displacementmap,Et.gradientmap,Et.fog,Et.lights,{emissive:{value:new $t(0)}}]),vertexShader:Kt.meshtoon_vert,fragmentShader:Kt.meshtoon_frag},matcap:{uniforms:en([Et.common,Et.bumpmap,Et.normalmap,Et.displacementmap,Et.fog,{matcap:{value:null}}]),vertexShader:Kt.meshmatcap_vert,fragmentShader:Kt.meshmatcap_frag},points:{uniforms:en([Et.points,Et.fog]),vertexShader:Kt.points_vert,fragmentShader:Kt.points_frag},dashed:{uniforms:en([Et.common,Et.fog,{scale:{value:1},dashSize:{value:1},totalSize:{value:2}}]),vertexShader:Kt.linedashed_vert,fragmentShader:Kt.linedashed_frag},depth:{uniforms:en([Et.common,Et.displacementmap]),vertexShader:Kt.depth_vert,fragmentShader:Kt.depth_frag},normal:{uniforms:en([Et.common,Et.bumpmap,Et.normalmap,Et.displacementmap,{opacity:{value:1}}]),vertexShader:Kt.meshnormal_vert,fragmentShader:Kt.meshnormal_frag},sprite:{uniforms:en([Et.sprite,Et.fog]),vertexShader:Kt.sprite_vert,fragmentShader:Kt.sprite_frag},background:{uniforms:{uvTransform:{value:new Xt},t2D:{value:null},backgroundIntensity:{value:1}},vertexShader:Kt.background_vert,fragmentShader:Kt.background_frag},backgroundCube:{uniforms:{envMap:{value:null},flipEnvMap:{value:-1},backgroundBlurriness:{value:0},backgroundIntensity:{value:1},backgroundRotation:{value:new Xt}},vertexShader:Kt.backgroundCube_vert,fragmentShader:Kt.backgroundCube_frag},cube:{uniforms:{tCube:{value:null},tFlip:{value:-1},opacity:{value:1}},vertexShader:Kt.cube_vert,fragmentShader:Kt.cube_frag},equirect:{uniforms:{tEquirect:{value:null}},vertexShader:Kt.equirect_vert,fragmentShader:Kt.equirect_frag},distance:{uniforms:en([Et.common,Et.displacementmap,{referencePosition:{value:new N},nearDistance:{value:1},farDistance:{value:1e3}}]),vertexShader:Kt.distance_vert,fragmentShader:Kt.distance_frag},shadow:{uniforms:en([Et.lights,Et.fog,{color:{value:new $t(0)},opacity:{value:1}}]),vertexShader:Kt.shadow_vert,fragmentShader:Kt.shadow_frag}};Kn.physical={uniforms:en([Kn.standard.uniforms,{clearcoat:{value:0},clearcoatMap:{value:null},clearcoatMapTransform:{value:new Xt},clearcoatNormalMap:{value:null},clearcoatNormalMapTransform:{value:new Xt},clearcoatNormalScale:{value:new it(1,1)},clearcoatRoughness:{value:0},clearcoatRoughnessMap:{value:null},clearcoatRoughnessMapTransform:{value:new Xt},dispersion:{value:0},iridescence:{value:0},iridescenceMap:{value:null},iridescenceMapTransform:{value:new Xt},iridescenceIOR:{value:1.3},iridescenceThicknessMinimum:{value:100},iridescenceThicknessMaximum:{value:400},iridescenceThicknessMap:{value:null},iridescenceThicknessMapTransform:{value:new Xt},sheen:{value:0},sheenColor:{value:new $t(0)},sheenColorMap:{value:null},sheenColorMapTransform:{value:new Xt},sheenRoughness:{value:1},sheenRoughnessMap:{value:null},sheenRoughnessMapTransform:{value:new Xt},transmission:{value:0},transmissionMap:{value:null},transmissionMapTransform:{value:new Xt},transmissionSamplerSize:{value:new it},transmissionSamplerMap:{value:null},thickness:{value:0},thicknessMap:{value:null},thicknessMapTransform:{value:new Xt},attenuationDistance:{value:0},attenuationColor:{value:new $t(0)},specularColor:{value:new $t(1,1,1)},specularColorMap:{value:null},specularColorMapTransform:{value:new Xt},specularIntensity:{value:1},specularIntensityMap:{value:null},specularIntensityMapTransform:{value:new Xt},anisotropyVector:{value:new it},anisotropyMap:{value:null},anisotropyMapTransform:{value:new Xt}}]),vertexShader:Kt.meshphysical_vert,fragmentShader:Kt.meshphysical_frag};const Ho={r:0,b:0,g:0},ss=new yn,sv=new jt;function rv(i,t,e,n,s,r,o){const a=new $t(0);let l=r===!0?0:1,c,h,u=null,d=0,f=null;function g(_){let v=_.isScene===!0?_.background:null;return v&&v.isTexture&&(v=(_.backgroundBlurriness>0?e:t).get(v)),v}function x(_){let v=!1;const S=g(_);S===null?p(a,l):S&&S.isColor&&(p(S,1),v=!0);const A=i.xr.getEnvironmentBlendMode();A==="additive"?n.buffers.color.setClear(0,0,0,1,o):A==="alpha-blend"&&n.buffers.color.setClear(0,0,0,0,o),(i.autoClear||v)&&(n.buffers.depth.setTest(!0),n.buffers.depth.setMask(!0),n.buffers.color.setMask(!0),i.clear(i.autoClearColor,i.autoClearDepth,i.autoClearStencil))}function m(_,v){const S=g(v);S&&(S.isCubeTexture||S.mapping===Ba)?(h===void 0&&(h=new Sn(new qi(1,1,1),new ri({name:"BackgroundCubeMaterial",uniforms:pr(Kn.backgroundCube.uniforms),vertexShader:Kn.backgroundCube.vertexShader,fragmentShader:Kn.backgroundCube.fragmentShader,side:rn,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),h.geometry.deleteAttribute("normal"),h.geometry.deleteAttribute("uv"),h.onBeforeRender=function(A,M,T){this.matrixWorld.copyPosition(T.matrixWorld)},Object.defineProperty(h.material,"envMap",{get:function(){return this.uniforms.envMap.value}}),s.update(h)),ss.copy(v.backgroundRotation),ss.x*=-1,ss.y*=-1,ss.z*=-1,S.isCubeTexture&&S.isRenderTargetTexture===!1&&(ss.y*=-1,ss.z*=-1),h.material.uniforms.envMap.value=S,h.material.uniforms.flipEnvMap.value=S.isCubeTexture&&S.isRenderTargetTexture===!1?-1:1,h.material.uniforms.backgroundBlurriness.value=v.backgroundBlurriness,h.material.uniforms.backgroundIntensity.value=v.backgroundIntensity,h.material.uniforms.backgroundRotation.value.setFromMatrix4(sv.makeRotationFromEuler(ss)),h.material.toneMapped=te.getTransfer(S.colorSpace)!==ae,(u!==S||d!==S.version||f!==i.toneMapping)&&(h.material.needsUpdate=!0,u=S,d=S.version,f=i.toneMapping),h.layers.enableAll(),_.unshift(h,h.geometry,h.material,0,0,null)):S&&S.isTexture&&(c===void 0&&(c=new Sn(new Fa(2,2),new ri({name:"BackgroundMaterial",uniforms:pr(Kn.background.uniforms),vertexShader:Kn.background.vertexShader,fragmentShader:Kn.background.fragmentShader,side:In,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),c.geometry.deleteAttribute("normal"),Object.defineProperty(c.material,"map",{get:function(){return this.uniforms.t2D.value}}),s.update(c)),c.material.uniforms.t2D.value=S,c.material.uniforms.backgroundIntensity.value=v.backgroundIntensity,c.material.toneMapped=te.getTransfer(S.colorSpace)!==ae,S.matrixAutoUpdate===!0&&S.updateMatrix(),c.material.uniforms.uvTransform.value.copy(S.matrix),(u!==S||d!==S.version||f!==i.toneMapping)&&(c.material.needsUpdate=!0,u=S,d=S.version,f=i.toneMapping),c.layers.enableAll(),_.unshift(c,c.geometry,c.material,0,0,null))}function p(_,v){_.getRGB(Ho,Df(i)),n.buffers.color.setClear(Ho.r,Ho.g,Ho.b,v,o)}function y(){h!==void 0&&(h.geometry.dispose(),h.material.dispose(),h=void 0),c!==void 0&&(c.geometry.dispose(),c.material.dispose(),c=void 0)}return{getClearColor:function(){return a},setClearColor:function(_,v=1){a.set(_),l=v,p(a,l)},getClearAlpha:function(){return l},setClearAlpha:function(_){l=_,p(a,l)},render:x,addToRenderList:m,dispose:y}}function ov(i,t){const e=i.getParameter(i.MAX_VERTEX_ATTRIBS),n={},s=d(null);let r=s,o=!1;function a(E,D,I,U,F){let V=!1;const G=u(U,I,D);r!==G&&(r=G,c(r.object)),V=f(E,U,I,F),V&&g(E,U,I,F),F!==null&&t.update(F,i.ELEMENT_ARRAY_BUFFER),(V||o)&&(o=!1,v(E,D,I,U),F!==null&&i.bindBuffer(i.ELEMENT_ARRAY_BUFFER,t.get(F).buffer))}function l(){return i.createVertexArray()}function c(E){return i.bindVertexArray(E)}function h(E){return i.deleteVertexArray(E)}function u(E,D,I){const U=I.wireframe===!0;let F=n[E.id];F===void 0&&(F={},n[E.id]=F);let V=F[D.id];V===void 0&&(V={},F[D.id]=V);let G=V[U];return G===void 0&&(G=d(l()),V[U]=G),G}function d(E){const D=[],I=[],U=[];for(let F=0;F<e;F++)D[F]=0,I[F]=0,U[F]=0;return{geometry:null,program:null,wireframe:!1,newAttributes:D,enabledAttributes:I,attributeDivisors:U,object:E,attributes:{},index:null}}function f(E,D,I,U){const F=r.attributes,V=D.attributes;let G=0;const k=I.getAttributes();for(const X in k)if(k[X].location>=0){const st=F[X];let gt=V[X];if(gt===void 0&&(X==="instanceMatrix"&&E.instanceMatrix&&(gt=E.instanceMatrix),X==="instanceColor"&&E.instanceColor&&(gt=E.instanceColor)),st===void 0||st.attribute!==gt||gt&&st.data!==gt.data)return!0;G++}return r.attributesNum!==G||r.index!==U}function g(E,D,I,U){const F={},V=D.attributes;let G=0;const k=I.getAttributes();for(const X in k)if(k[X].location>=0){let st=V[X];st===void 0&&(X==="instanceMatrix"&&E.instanceMatrix&&(st=E.instanceMatrix),X==="instanceColor"&&E.instanceColor&&(st=E.instanceColor));const gt={};gt.attribute=st,st&&st.data&&(gt.data=st.data),F[X]=gt,G++}r.attributes=F,r.attributesNum=G,r.index=U}function x(){const E=r.newAttributes;for(let D=0,I=E.length;D<I;D++)E[D]=0}function m(E){p(E,0)}function p(E,D){const I=r.newAttributes,U=r.enabledAttributes,F=r.attributeDivisors;I[E]=1,U[E]===0&&(i.enableVertexAttribArray(E),U[E]=1),F[E]!==D&&(i.vertexAttribDivisor(E,D),F[E]=D)}function y(){const E=r.newAttributes,D=r.enabledAttributes;for(let I=0,U=D.length;I<U;I++)D[I]!==E[I]&&(i.disableVertexAttribArray(I),D[I]=0)}function _(E,D,I,U,F,V,G){G===!0?i.vertexAttribIPointer(E,D,I,F,V):i.vertexAttribPointer(E,D,I,U,F,V)}function v(E,D,I,U){x();const F=U.attributes,V=I.getAttributes(),G=D.defaultAttributeValues;for(const k in V){const X=V[k];if(X.location>=0){let ht=F[k];if(ht===void 0&&(k==="instanceMatrix"&&E.instanceMatrix&&(ht=E.instanceMatrix),k==="instanceColor"&&E.instanceColor&&(ht=E.instanceColor)),ht!==void 0){const st=ht.normalized,gt=ht.itemSize,Ot=t.get(ht);if(Ot===void 0)continue;const Ht=Ot.buffer,Z=Ot.type,z=Ot.bytesPerElement,R=Z===i.INT||Z===i.UNSIGNED_INT||ht.gpuType===dh;if(ht.isInterleavedBufferAttribute){const P=ht.data,q=P.stride,nt=ht.offset;if(P.isInstancedInterleavedBuffer){for(let Y=0;Y<X.locationSize;Y++)p(X.location+Y,P.meshPerAttribute);E.isInstancedMesh!==!0&&U._maxInstanceCount===void 0&&(U._maxInstanceCount=P.meshPerAttribute*P.count)}else for(let Y=0;Y<X.locationSize;Y++)m(X.location+Y);i.bindBuffer(i.ARRAY_BUFFER,Ht);for(let Y=0;Y<X.locationSize;Y++)_(X.location+Y,gt/X.locationSize,Z,st,q*z,(nt+gt/X.locationSize*Y)*z,R)}else{if(ht.isInstancedBufferAttribute){for(let P=0;P<X.locationSize;P++)p(X.location+P,ht.meshPerAttribute);E.isInstancedMesh!==!0&&U._maxInstanceCount===void 0&&(U._maxInstanceCount=ht.meshPerAttribute*ht.count)}else for(let P=0;P<X.locationSize;P++)m(X.location+P);i.bindBuffer(i.ARRAY_BUFFER,Ht);for(let P=0;P<X.locationSize;P++)_(X.location+P,gt/X.locationSize,Z,st,gt*z,gt/X.locationSize*P*z,R)}}else if(G!==void 0){const st=G[k];if(st!==void 0)switch(st.length){case 2:i.vertexAttrib2fv(X.location,st);break;case 3:i.vertexAttrib3fv(X.location,st);break;case 4:i.vertexAttrib4fv(X.location,st);break;default:i.vertexAttrib1fv(X.location,st)}}}}y()}function S(){T();for(const E in n){const D=n[E];for(const I in D){const U=D[I];for(const F in U)h(U[F].object),delete U[F];delete D[I]}delete n[E]}}function A(E){if(n[E.id]===void 0)return;const D=n[E.id];for(const I in D){const U=D[I];for(const F in U)h(U[F].object),delete U[F];delete D[I]}delete n[E.id]}function M(E){for(const D in n){const I=n[D];if(I[E.id]===void 0)continue;const U=I[E.id];for(const F in U)h(U[F].object),delete U[F];delete I[E.id]}}function T(){b(),o=!0,r!==s&&(r=s,c(r.object))}function b(){s.geometry=null,s.program=null,s.wireframe=!1}return{setup:a,reset:T,resetDefaultState:b,dispose:S,releaseStatesOfGeometry:A,releaseStatesOfProgram:M,initAttributes:x,enableAttribute:m,disableUnusedAttributes:y}}function av(i,t,e){let n;function s(c){n=c}function r(c,h){i.drawArrays(n,c,h),e.update(h,n,1)}function o(c,h,u){u!==0&&(i.drawArraysInstanced(n,c,h,u),e.update(h,n,u))}function a(c,h,u){if(u===0)return;t.get("WEBGL_multi_draw").multiDrawArraysWEBGL(n,c,0,h,0,u);let f=0;for(let g=0;g<u;g++)f+=h[g];e.update(f,n,1)}function l(c,h,u,d){if(u===0)return;const f=t.get("WEBGL_multi_draw");if(f===null)for(let g=0;g<c.length;g++)o(c[g],h[g],d[g]);else{f.multiDrawArraysInstancedWEBGL(n,c,0,h,0,d,0,u);let g=0;for(let x=0;x<u;x++)g+=h[x]*d[x];e.update(g,n,1)}}this.setMode=s,this.render=r,this.renderInstances=o,this.renderMultiDraw=a,this.renderMultiDrawInstances=l}function lv(i,t,e,n){let s;function r(){if(s!==void 0)return s;if(t.has("EXT_texture_filter_anisotropic")===!0){const M=t.get("EXT_texture_filter_anisotropic");s=i.getParameter(M.MAX_TEXTURE_MAX_ANISOTROPY_EXT)}else s=0;return s}function o(M){return!(M!==Yn&&n.convert(M)!==i.getParameter(i.IMPLEMENTATION_COLOR_READ_FORMAT))}function a(M){const T=M===Ai&&(t.has("EXT_color_buffer_half_float")||t.has("EXT_color_buffer_float"));return!(M!==_n&&n.convert(M)!==i.getParameter(i.IMPLEMENTATION_COLOR_READ_TYPE)&&M!==Jn&&!T)}function l(M){if(M==="highp"){if(i.getShaderPrecisionFormat(i.VERTEX_SHADER,i.HIGH_FLOAT).precision>0&&i.getShaderPrecisionFormat(i.FRAGMENT_SHADER,i.HIGH_FLOAT).precision>0)return"highp";M="mediump"}return M==="mediump"&&i.getShaderPrecisionFormat(i.VERTEX_SHADER,i.MEDIUM_FLOAT).precision>0&&i.getShaderPrecisionFormat(i.FRAGMENT_SHADER,i.MEDIUM_FLOAT).precision>0?"mediump":"lowp"}let c=e.precision!==void 0?e.precision:"highp";const h=l(c);h!==c&&(Gt("WebGLRenderer:",c,"not supported, using",h,"instead."),c=h);const u=e.logarithmicDepthBuffer===!0,d=e.reversedDepthBuffer===!0&&t.has("EXT_clip_control"),f=i.getParameter(i.MAX_TEXTURE_IMAGE_UNITS),g=i.getParameter(i.MAX_VERTEX_TEXTURE_IMAGE_UNITS),x=i.getParameter(i.MAX_TEXTURE_SIZE),m=i.getParameter(i.MAX_CUBE_MAP_TEXTURE_SIZE),p=i.getParameter(i.MAX_VERTEX_ATTRIBS),y=i.getParameter(i.MAX_VERTEX_UNIFORM_VECTORS),_=i.getParameter(i.MAX_VARYING_VECTORS),v=i.getParameter(i.MAX_FRAGMENT_UNIFORM_VECTORS),S=i.getParameter(i.MAX_SAMPLES),A=i.getParameter(i.SAMPLES);return{isWebGL2:!0,getMaxAnisotropy:r,getMaxPrecision:l,textureFormatReadable:o,textureTypeReadable:a,precision:c,logarithmicDepthBuffer:u,reversedDepthBuffer:d,maxTextures:f,maxVertexTextures:g,maxTextureSize:x,maxCubemapSize:m,maxAttributes:p,maxVertexUniforms:y,maxVaryings:_,maxFragmentUniforms:v,maxSamples:S,samples:A}}function cv(i){const t=this;let e=null,n=0,s=!1,r=!1;const o=new Vn,a=new Xt,l={value:null,needsUpdate:!1};this.uniform=l,this.numPlanes=0,this.numIntersection=0,this.init=function(u,d){const f=u.length!==0||d||n!==0||s;return s=d,n=u.length,f},this.beginShadows=function(){r=!0,h(null)},this.endShadows=function(){r=!1},this.setGlobalState=function(u,d){e=h(u,d,0)},this.setState=function(u,d,f){const g=u.clippingPlanes,x=u.clipIntersection,m=u.clipShadows,p=i.get(u);if(!s||g===null||g.length===0||r&&!m)r?h(null):c();else{const y=r?0:n,_=y*4;let v=p.clippingState||null;l.value=v,v=h(g,d,_,f);for(let S=0;S!==_;++S)v[S]=e[S];p.clippingState=v,this.numIntersection=x?this.numPlanes:0,this.numPlanes+=y}};function c(){l.value!==e&&(l.value=e,l.needsUpdate=n>0),t.numPlanes=n,t.numIntersection=0}function h(u,d,f,g){const x=u!==null?u.length:0;let m=null;if(x!==0){if(m=l.value,g!==!0||m===null){const p=f+x*4,y=d.matrixWorldInverse;a.getNormalMatrix(y),(m===null||m.length<p)&&(m=new Float32Array(p));for(let _=0,v=f;_!==x;++_,v+=4)o.copy(u[_]).applyMatrix4(y,a),o.normal.toArray(m,v),m[v+3]=o.constant}l.value=m,l.needsUpdate=!0}return t.numPlanes=x,t.numIntersection=0,m}}function hv(i){let t=new WeakMap;function e(o,a){return a===fc?o.mapping=Es:a===pc&&(o.mapping=ur),o}function n(o){if(o&&o.isTexture){const a=o.mapping;if(a===fc||a===pc)if(t.has(o)){const l=t.get(o).texture;return e(l,o.mapping)}else{const l=o.image;if(l&&l.height>0){const c=new Bf(l.height);return c.fromEquirectangularTexture(i,o),t.set(o,c),o.addEventListener("dispose",s),e(c.texture,o.mapping)}else return null}}return o}function s(o){const a=o.target;a.removeEventListener("dispose",s);const l=t.get(a);l!==void 0&&(t.delete(a),l.dispose())}function r(){t=new WeakMap}return{get:n,dispose:r}}const Hi=4,Gu=[.125,.215,.35,.446,.526,.582],ds=20,uv=256,Cr=new Rh,Hu=new $t;let El=null,Al=0,wl=0,Tl=!1;const dv=new N;class Wu{constructor(t){this._renderer=t,this._pingPongRenderTarget=null,this._lodMax=0,this._cubeSize=0,this._sizeLods=[],this._sigmas=[],this._lodMeshes=[],this._backgroundBox=null,this._cubemapMaterial=null,this._equirectMaterial=null,this._blurMaterial=null,this._ggxMaterial=null}fromScene(t,e=0,n=.1,s=100,r={}){const{size:o=256,position:a=dv}=r;El=this._renderer.getRenderTarget(),Al=this._renderer.getActiveCubeFace(),wl=this._renderer.getActiveMipmapLevel(),Tl=this._renderer.xr.enabled,this._renderer.xr.enabled=!1,this._setSize(o);const l=this._allocateTargets();return l.depthBuffer=!0,this._sceneToCubeUV(t,n,s,l,a),e>0&&this._blur(l,0,0,e),this._applyPMREM(l),this._cleanup(l),l}fromEquirectangular(t,e=null){return this._fromTexture(t,e)}fromCubemap(t,e=null){return this._fromTexture(t,e)}compileCubemapShader(){this._cubemapMaterial===null&&(this._cubemapMaterial=$u(),this._compileMaterial(this._cubemapMaterial))}compileEquirectangularShader(){this._equirectMaterial===null&&(this._equirectMaterial=Yu(),this._compileMaterial(this._equirectMaterial))}dispose(){this._dispose(),this._cubemapMaterial!==null&&this._cubemapMaterial.dispose(),this._equirectMaterial!==null&&this._equirectMaterial.dispose(),this._backgroundBox!==null&&(this._backgroundBox.geometry.dispose(),this._backgroundBox.material.dispose())}_setSize(t){this._lodMax=Math.floor(Math.log2(t)),this._cubeSize=Math.pow(2,this._lodMax)}_dispose(){this._blurMaterial!==null&&this._blurMaterial.dispose(),this._ggxMaterial!==null&&this._ggxMaterial.dispose(),this._pingPongRenderTarget!==null&&this._pingPongRenderTarget.dispose();for(let t=0;t<this._lodMeshes.length;t++)this._lodMeshes[t].geometry.dispose()}_cleanup(t){this._renderer.setRenderTarget(El,Al,wl),this._renderer.xr.enabled=Tl,t.scissorTest=!1,Xs(t,0,0,t.width,t.height)}_fromTexture(t,e){t.mapping===Es||t.mapping===ur?this._setSize(t.image.length===0?16:t.image[0].width||t.image[0].image.width):this._setSize(t.image.width/4),El=this._renderer.getRenderTarget(),Al=this._renderer.getActiveCubeFace(),wl=this._renderer.getActiveMipmapLevel(),Tl=this._renderer.xr.enabled,this._renderer.xr.enabled=!1;const n=e||this._allocateTargets();return this._textureToCubeUV(t,n),this._applyPMREM(n),this._cleanup(n),n}_allocateTargets(){const t=3*Math.max(this._cubeSize,112),e=4*this._cubeSize,n={magFilter:je,minFilter:je,generateMipmaps:!1,type:Ai,format:Yn,colorSpace:fr,depthBuffer:!1},s=Xu(t,e,n);if(this._pingPongRenderTarget===null||this._pingPongRenderTarget.width!==t||this._pingPongRenderTarget.height!==e){this._pingPongRenderTarget!==null&&this._dispose(),this._pingPongRenderTarget=Xu(t,e,n);const{_lodMax:r}=this;({lodMeshes:this._lodMeshes,sizeLods:this._sizeLods,sigmas:this._sigmas}=fv(r)),this._blurMaterial=mv(r,t,e),this._ggxMaterial=pv(r,t,e)}return s}_compileMaterial(t){const e=new Sn(new Ie,t);this._renderer.compile(e,Cr)}_sceneToCubeUV(t,e,n,s,r){const l=new wn(90,1,e,n),c=[1,-1,1,1,1,1],h=[1,1,1,-1,-1,-1],u=this._renderer,d=u.autoClear,f=u.toneMapping;u.getClearColor(Hu),u.toneMapping=ei,u.autoClear=!1,u.state.buffers.depth.getReversed()&&(u.setRenderTarget(s),u.clearDepth(),u.setRenderTarget(null)),this._backgroundBox===null&&(this._backgroundBox=new Sn(new qi,new Pf({name:"PMREM.Background",side:rn,depthWrite:!1,depthTest:!1})));const x=this._backgroundBox,m=x.material;let p=!1;const y=t.background;y?y.isColor&&(m.color.copy(y),t.background=null,p=!0):(m.color.copy(Hu),p=!0);for(let _=0;_<6;_++){const v=_%3;v===0?(l.up.set(0,c[_],0),l.position.set(r.x,r.y,r.z),l.lookAt(r.x+h[_],r.y,r.z)):v===1?(l.up.set(0,0,c[_]),l.position.set(r.x,r.y,r.z),l.lookAt(r.x,r.y+h[_],r.z)):(l.up.set(0,c[_],0),l.position.set(r.x,r.y,r.z),l.lookAt(r.x,r.y,r.z+h[_]));const S=this._cubeSize;Xs(s,v*S,_>2?S:0,S,S),u.setRenderTarget(s),p&&u.render(x,l),u.render(t,l)}u.toneMapping=f,u.autoClear=d,t.background=y}_textureToCubeUV(t,e){const n=this._renderer,s=t.mapping===Es||t.mapping===ur;s?(this._cubemapMaterial===null&&(this._cubemapMaterial=$u()),this._cubemapMaterial.uniforms.flipEnvMap.value=t.isRenderTargetTexture===!1?-1:1):this._equirectMaterial===null&&(this._equirectMaterial=Yu());const r=s?this._cubemapMaterial:this._equirectMaterial,o=this._lodMeshes[0];o.material=r;const a=r.uniforms;a.envMap.value=t;const l=this._cubeSize;Xs(e,0,0,3*l,2*l),n.setRenderTarget(e),n.render(o,Cr)}_applyPMREM(t){const e=this._renderer,n=e.autoClear;e.autoClear=!1;const s=this._lodMeshes.length;for(let r=1;r<s;r++)this._applyGGXFilter(t,r-1,r);e.autoClear=n}_applyGGXFilter(t,e,n){const s=this._renderer,r=this._pingPongRenderTarget,o=this._ggxMaterial,a=this._lodMeshes[n];a.material=o;const l=o.uniforms,c=n/(this._lodMeshes.length-1),h=e/(this._lodMeshes.length-1),u=Math.sqrt(c*c-h*h),d=0+c*1.25,f=u*d,{_lodMax:g}=this,x=this._sizeLods[n],m=3*x*(n>g-Hi?n-g+Hi:0),p=4*(this._cubeSize-x);l.envMap.value=t.texture,l.roughness.value=f,l.mipInt.value=g-e,Xs(r,m,p,3*x,2*x),s.setRenderTarget(r),s.render(a,Cr),l.envMap.value=r.texture,l.roughness.value=0,l.mipInt.value=g-n,Xs(t,m,p,3*x,2*x),s.setRenderTarget(t),s.render(a,Cr)}_blur(t,e,n,s,r){const o=this._pingPongRenderTarget;this._halfBlur(t,o,e,n,s,"latitudinal",r),this._halfBlur(o,t,n,n,s,"longitudinal",r)}_halfBlur(t,e,n,s,r,o,a){const l=this._renderer,c=this._blurMaterial;o!=="latitudinal"&&o!=="longitudinal"&&ie("blur direction must be either latitudinal or longitudinal!");const h=3,u=this._lodMeshes[s];u.material=c;const d=c.uniforms,f=this._sizeLods[n]-1,g=isFinite(r)?Math.PI/(2*f):2*Math.PI/(2*ds-1),x=r/g,m=isFinite(r)?1+Math.floor(h*x):ds;m>ds&&Gt(`sigmaRadians, ${r}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${ds}`);const p=[];let y=0;for(let M=0;M<ds;++M){const T=M/x,b=Math.exp(-T*T/2);p.push(b),M===0?y+=b:M<m&&(y+=2*b)}for(let M=0;M<p.length;M++)p[M]=p[M]/y;d.envMap.value=t.texture,d.samples.value=m,d.weights.value=p,d.latitudinal.value=o==="latitudinal",a&&(d.poleAxis.value=a);const{_lodMax:_}=this;d.dTheta.value=g,d.mipInt.value=_-n;const v=this._sizeLods[s],S=3*v*(s>_-Hi?s-_+Hi:0),A=4*(this._cubeSize-v);Xs(e,S,A,3*v,2*v),l.setRenderTarget(e),l.render(u,Cr)}}function fv(i){const t=[],e=[],n=[];let s=i;const r=i-Hi+1+Gu.length;for(let o=0;o<r;o++){const a=Math.pow(2,s);t.push(a);let l=1/a;o>i-Hi?l=Gu[o-i+Hi-1]:o===0&&(l=0),e.push(l);const c=1/(a-2),h=-c,u=1+c,d=[h,h,u,h,u,u,h,h,u,u,h,u],f=6,g=6,x=3,m=2,p=1,y=new Float32Array(x*g*f),_=new Float32Array(m*g*f),v=new Float32Array(p*g*f);for(let A=0;A<f;A++){const M=A%3*2/3-1,T=A>2?0:-1,b=[M,T,0,M+2/3,T,0,M+2/3,T+1,0,M,T,0,M+2/3,T+1,0,M,T+1,0];y.set(b,x*g*A),_.set(d,m*g*A);const E=[A,A,A,A,A,A];v.set(E,p*g*A)}const S=new Ie;S.setAttribute("position",new Ke(y,x)),S.setAttribute("uv",new Ke(_,m)),S.setAttribute("faceIndex",new Ke(v,p)),n.push(new Sn(S,null)),s>Hi&&s--}return{lodMeshes:n,sizeLods:t,sigmas:e}}function Xu(i,t,e){const n=new ni(i,t,e);return n.texture.mapping=Ba,n.texture.name="PMREM.cubeUv",n.scissorTest=!0,n}function Xs(i,t,e,n,s){i.viewport.set(t,e,n,s),i.scissor.set(t,e,n,s)}function pv(i,t,e){return new ri({name:"PMREMGGXConvolution",defines:{GGX_SAMPLES:uv,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},roughness:{value:0},mipInt:{value:0}},vertexShader:ka(),fragmentShader:`
		...
		`,blending:bi,depthTest:!1,depthWrite:!1})}function $u(){return new ri({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ka(),fragmentShader:`
	...
	`}function gv(i){let t=new WeakMap,e=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===fc||l===pc,h=l===Es||l===ur;if(c||h){let u=t.get(a);const d=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return e===null&&(e=new Wu(i)),u=c?e.fromEquirectangular(a,u):e.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,t.set(a,u),u.texture;if(u!==void 0)return u.texture;{const f=a.image;return c&&f&&f.height>0||h&&f&&s(f)?(e===null&&(e=new Wu(i)),u=c?e.fromEquirectangular(a):e.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,t.set(a,u),a.addEventListener("dispose",r),u.texture):null}}}return a}function s(a){let l=0;const c=6;for(let h=0;h<c;h++)a[h]!==void 0&&l++;return l===c}function r(a){const l=a.target;l.removeEventListener("dispose",r);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function o(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:o}}function xv(i){const t={};function e(n){if(t[n]!==void 0)return t[n];const s=i.getExtension(n);return t[n]=s,s}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const s=e(n);return s===null&&jr("WebGLRenderer: "+n+" extension not supported."),s}}}function _v(i,t,e,n){const s={},r=new WeakMap;function o(u){const d=u.target;d.index!==null&&t.remove(d.index);for(const g in d.attributes)t.remove(d.attributes[g]);d.removeEventListener("dispose",o),delete s[d.id];const f=r.get(d);f&&(t.remove(f),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,e.memory.geometries--}function a(u,d){return s[d.id]===!0||(d.addEventListener("dispose",o),s[d.id]=!0,e.memory.geometries++),d}function l(u){const d=u.attributes;for(const f in d)t.update(d[f],i.ARRAY_BUFFER)}function c(u){const d=[],f=u.index,g=u.attributes.position;let x=0;if(f!==null){const y=f.array;x=f.version;for(let _=0,v=y.length;_<v;_+=3){const S=y[_+0],A=y[_+1],M=y[_+2];d.push(S,A,A,M,M,S)}}else if(g!==void 0){const y=g.array;x=g.version;for(let _=0,v=y.length/3-1;_<v;_+=3){const S=_+0,A=_+1,M=_+2;d.push(S,A,A,M,M,S)}}else return;const m=new(Af(d)?Lf:Rf)(d,1);m.version=x;const p=r.get(u);p&&t.remove(p),r.set(u,m)}function h(u){const d=r.get(u);if(d){const f=u.index;f!==null&&d.version<f.version&&c(u)}else c(u);return r.get(u)}return{get:a,update:l,getWireframeAttribute:h}}function vv(i,t,e){let n;function s(d){n=d}let r,o;function a(d){r=d.type,o=d.bytesPerElement}function l(d,f){i.drawElements(n,f,r,d*o),e.update(f,n,1)}function c(d,f,g){g!==0&&(i.drawElementsInstanced(n,f,r,d*o,g),e.update(f,n,g))}function h(d,f,g){if(g===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,r,d,0,g);let m=0;for(let p=0;p<g;p++)m+=f[p];e.update(m,n,1)}function u(d,f,g,x){if(g===0)return;const m=t.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<d.length;p++)c(d[p]/o,f[p],x[p]);else{m.multiDrawElementsInstancedWEBGL(n,f,0,r,d,0,x,0,g);let p=0;for(let y=0;y<g;y++)p+=f[y]*x[y];e.update(p,n,1)}}this.setMode=s,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function yv(i){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(e.calls++,o){case i.TRIANGLES:e.triangles+=a*(r/3);break;case i.LINES:e.lines+=a*(r/2);break;case i.LINE_STRIP:e.lines+=a*(r-1);break;case i.LINE_LOOP:e.lines+=a*r;break;case i.POINTS:e.points+=a*r;break;default:ie("WebGLInfo: Unknown draw mode:",o);break}}function s(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:s,update:n}}function Sv(i,t,e){const n=new WeakMap,s=new ce;function r(o,a,l){const c=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=h!==void 0?h.length:0;let d=n.get(a);if(d===void 0||d.count!==u){let E=function(){T.dispose(),n.delete(a),a.removeEventListener("dispose",E)};var f=E;d!==void 0&&d.texture.dispose();const g=a.morphAttributes.position!==void 0,x=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,p=a.morphAttributes.position||[],y=a.morphAttributes.normal||[],_=a.morphAttributes.color||[];let v=0;g===!0&&(v=1),x===!0&&(v=2),m===!0&&(v=3);let S=a.attributes.position.count*v,A=1;S>t.maxTextureSize&&(A=Math.ceil(S/t.maxTextureSize),S=t.maxTextureSize);const M=new Float32Array(S*A*4*u),T=new wf(M,S,A,u);T.type=Jn,T.needsUpdate=!0;const b=v*4;for(let D=0;D<u;D++){const I=p[D],U=y[D],F=_[D],V=S*A*4*D;for(let G=0;G<I.count;G++){const k=G*b;g===!0&&(s.fromBufferAttribute(I,G),M[V+k+0]=s.x,M[V+k+1]=s.y,M[V+k+2]=s.z,M[V+k+3]=0),x===!0&&(s.fromBufferAttribute(U,G),M[V+k+4]=s.x,M[V+k+5]=s.y,M[V+k+6]=s.z,M[V+k+7]=0),m===!0&&(s.fromBufferAttribute(F,G),M[V+k+8]=s.x,M[V+k+9]=s.y,M[V+k+10]=s.z,M[V+k+11]=F.itemSize===4?s.w:1)}}d={count:u,texture:T,size:new it(S,A)},n.set(a,d),a.addEventListener("dispose",E)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",o.morphTexture,e);else{let g=0;for(let m=0;m<c.length;m++)g+=c[m];const x=a.morphTargetsRelative?1:1-g;l.getUniforms().setValue(i,"morphTargetBaseInfluence",x),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",d.texture,e),l.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:r}}function bv(i,t,e,n){let s=new WeakMap;function r(l){const c=n.render.frame,h=l.geometry,u=t.get(l,h);if(s.get(u)!==c&&(t.update(u),s.set(u,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),s.get(l)!==c&&(e.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;s.get(d)!==c&&(d.update(),s.set(d,c))}return u}function o(){s=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:r,dispose:o}}const Mv={[cf]:"LINEAR_TONE_MAPPING",[hf]:"REINHARD_TONE_MAPPING",[uf]:"CINEON_TONE_MAPPING",[df]:"ACES_FILMIC_TONE_MAPPING",[pf]:"AGX_TONE_MAPPING",[mf]:"NEUTRAL_TONE_MAPPING",[ff]:"CUSTOM_TONE_MAPPING"};function Ev(i,t,e,n,s){const r=new ni(t,e,{type:i,depthBuffer:n,stencilBuffer:s}),o=new ni(t,e,{type:Ai,depthBuffer:!1,stencilBuffer:!1}),a=new Ie;a.setAttribute("position",new Me([-1,3,0,-1,-1,0,3,-1,0],3)),a.setAttribute("uv",new Me([0,2,0,0,2,0],2));const l=new i0({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),c=new Sn(a,l),h=new Rh(-1,1,1,-1,0,1);let u=null,d=null,f=!1,g,x=null,m=[],p=!1;this.setSize=function(y,_){r.setSize(y,_),o.setSize(y,_);for(let v=0;v<m.length;v++){const S=m[v];S.setSize&&S.setSize(y,_)}},this.setEffects=function(y){m=y,p=m.length>0&&m[0].isRenderPass===!0;const _=r.width,v=r.height;for(let S=0;S<m.length;S++){const A=m[S];A.setSize&&A.setSize(_,v)}},this.begin=function(y,_){if(f||y.toneMapping===ei&&m.length===0)return!1;if(x=_,_!==null){const v=_.width,S=_.height;(r.width!==v||r.height!==S)&&this.setSize(v,S)}return p===!1&&y.setRenderTarget(r),g=y.toneMapping,y.toneMapping=ei,!0},this.hasRenderPass=function(){return p},this.end=function(y,_){y.toneMapping=g,f=!0;let v=r,S=o;for(let A=0;A<m.length;A++){const M=m[A];if(M.enabled!==!1&&(M.render(y,S,v,_),M.needsSwap!==!1)){const T=v;v=S,S=T}}if(u!==y.outputColorSpace||d!==y.toneMapping){u=y.outputColorSpace,d=y.toneMapping,l.defines={},te.getTransfer(u)===ae&&(l.defines.SRGB_TRANSFER="");const A=Mv[d];A&&(l.defines[A]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=v.texture,y.setRenderTarget(x),y.render(c,h),x=null,f=!1},this.isCompositing=function(){return f},this.dispose=function(){r.dispose(),o.dispose(),a.dispose(),l.dispose()}}const Yf=new on,Kc=new Jr(1,1),$f=new wf,qf=new sg,Zf=new Nf,qu=[],Zu=[],ju=new Float32Array(16),Ku=new Float32Array(9),Ju=new Float32Array(4);function Sr(i,t,e){const n=i[0];if(n<=0||n>0)return i;const s=t*e;let r=qu[s];if(r===void 0&&(r=new Float32Array(s),qu[s]=r),t!==0){n.toArray(r,0);for(let o=1,a=0;o!==t;++o)a+=e,i[o].toArray(r,a)}return r}function Ne(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function Be(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function za(i,t){let e=Zu[t];e===void 0&&(e=new Int32Array(t),Zu[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function Av(i,t){const e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function wv(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ne(e,t))return;i.uniform2fv(this.addr,t),Be(e,t)}}function Tv(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(Ne(e,t))return;i.uniform3fv(this.addr,t),Be(e,t)}}function Cv(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ne(e,t))return;i.uniform4fv(this.addr,t),Be(e,t)}}function Pv(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ne(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),Be(e,t)}else{if(Ne(e,n))return;Ju.set(n),i.uniformMatrix2fv(this.addr,!1,Ju),Be(e,n)}}function Rv(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ne(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),Be(e,t)}else{if(Ne(e,n))return;Ku.set(n),i.uniformMatrix3fv(this.addr,!1,Ku),Be(e,n)}}function Lv(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ne(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),Be(e,t)}else{if(Ne(e,n))return;ju.set(n),i.uniformMatrix4fv(this.addr,!1,ju),Be(e,n)}}function Dv(i,t){const e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function Iv(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ne(e,t))return;i.uniform2iv(this.addr,t),Be(e,t)}}function Nv(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Ne(e,t))return;i.uniform3iv(this.addr,t),Be(e,t)}}function Bv(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ne(e,t))return;i.uniform4iv(this.addr,t),Be(e,t)}}function Uv(i,t){const e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function Fv(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ne(e,t))return;i.uniform2uiv(this.addr,t),Be(e,t)}}function Ov(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Ne(e,t))return;i.uniform3uiv(this.addr,t),Be(e,t)}}function kv(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ne(e,t))return;i.uniform4uiv(this.addr,t),Be(e,t)}}function zv(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(Kc.compareFunction=e.isReversedDepthBuffer()?vh:_h,r=Kc):r=Yf,e.setTexture2D(t||r,s)}function Vv(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture3D(t||qf,s)}function Gv(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTextureCube(t||Zf,s)}function Hv(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture2DArray(t||$f,s)}function Wv(i){switch(i){case 5126:return Av;case 35664:return wv;case 35665:return Tv;case 35666:return Cv;case 35674:return Pv;case 35675:return Rv;case 35676:return Lv;case 5124:case 35670:return Dv;case 35667:case 35671:return Iv;case 35668:case 35672:return Nv;case 35669:case 35673:return Bv;case 5125:return Uv;case 36294:return Fv;case 36295:return Ov;case 36296:return kv;case 35678:case 36198:case 36298:case 36306:case 35682:return zv;case 35679:case 36299:case 36307:return Vv;case 35680:case 36300:case 36308:case 36293:return Gv;case 36289:case 36303:case 36311:case 36292:return Hv}}function Xv(i,t){i.uniform1fv(this.addr,t)}function Yv(i,t){const e=Sr(t,this.size,2);i.uniform2fv(this.addr,e)}function $v(i,t){const e=Sr(t,this.size,3);i.uniform3fv(this.addr,e)}function qv(i,t){const e=Sr(t,this.size,4);i.uniform4fv(this.addr,e)}function Zv(i,t){const e=Sr(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function jv(i,t){const e=Sr(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function Kv(i,t){const e=Sr(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function Jv(i,t){i.uniform1iv(this.addr,t)}function Qv(i,t){i.uniform2iv(this.addr,t)}function ty(i,t){i.uniform3iv(this.addr,t)}function ey(i,t){i.uniform4iv(this.addr,t)}function ny(i,t){i.uniform1uiv(this.addr,t)}function iy(i,t){i.uniform2uiv(this.addr,t)}function sy(i,t){i.uniform3uiv(this.addr,t)}function ry(i,t){i.uniform4uiv(this.addr,t)}function oy(i,t,e){const n=this.cache,s=t.length,r=za(e,s);Ne(n,r)||(i.uniform1iv(this.addr,r),Be(n,r));let o;this.type===i.SAMPLER_2D_SHADOW?o=Kc:o=Yf;for(let a=0;a!==s;++a)e.setTexture2D(t[a]||o,r[a])}function ay(i,t,e){const n=this.cache,s=t.length,r=za(e,s);Ne(n,r)||(i.uniform1iv(this.addr,r),Be(n,r));for(let o=0;o!==s;++o)e.setTexture3D(t[o]||qf,r[o])}function ly(i,t,e){const n=this.cache,s=t.length,r=za(e,s);Ne(n,r)||(i.uniform1iv(this.addr,r),Be(n,r));for(let o=0;o!==s;++o)e.setTextureCube(t[o]||Zf,r[o])}function cy(i,t,e){const n=this.cache,s=t.length,r=za(e,s);Ne(n,r)||(i.uniform1iv(this.addr,r),Be(n,r));for(let o=0;o!==s;++o)e.setTexture2DArray(t[o]||$f,r[o])}function hy(i){switch(i){case 5126:return Xv;case 35664:return Yv;case 35665:return $v;case 35666:return qv;case 35674:return Zv;case 35675:return jv;case 35676:return Kv;case 5124:case 35670:return Jv;case 35667:case 35671:return Qv;case 35668:case 35672:return ty;case 35669:case 35673:return ey;case 5125:return ny;case 36294:return iy;case 36295:return sy;case 36296:return ry;case 35678:case 36198:case 36298:case 36306:case 35682:return oy;case 35679:case 36299:case 36307:return ay;case 35680:case 36300:case 36308:case 36293:return ly;case 36289:case 36303:case 36311:case 36292:return cy}}class uy{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=Wv(e.type)}}class dy{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=hy(e.type)}}class fy{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const s=this.seq;for(let r=0,o=s.length;r!==o;++r){const a=s[r];a.setValue(t,e[a.id],n)}}}const Cl=/(\w+)(\])?(\[|\.)?/g;function Qu(i,t){i.seq.push(t),i.map[t.id]=t}function py(i,t,e){const n=i.name,s=n.length;for(Cl.lastIndex=0;;){const r=Cl.exec(n),o=Cl.lastIndex;let a=r[1];const l=r[2]==="]",c=r[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===s){Qu(e,c===void 0?new uy(a,i,t):new dy(a,i,t));break}else{let u=e.map[a];u===void 0&&(u=new fy(a),Qu(e,u)),e=u}}}class ya{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let o=0;o<n;++o){const a=t.getActiveUniform(e,o),l=t.getUniformLocation(e,a.name);py(a,l,this)}const s=[],r=[];for(const o of this.seq)o.type===t.SAMPLER_2D_SHADOW||o.type===t.SAMPLER_CUBE_SHADOW||o.type===t.SAMPLER_2D_ARRAY_SHADOW?s.push(o):r.push(o);s.length>0&&(this.seq=s.concat(r))}setValue(t,e,n,s){const r=this.map[e];r!==void 0&&r.setValue(t,n,s)}setOptional(t,e,n){const s=e[n];s!==void 0&&this.setValue(t,n,s)}static upload(t,e,n,s){for(let r=0,o=e.length;r!==o;++r){const a=e[r],l=n[a.id];l.needsUpdate!==!1&&a.setValue(t,l.value,s)}}static seqWithValue(t,e){const n=[];for(let s=0,r=t.length;s!==r;++s){const o=t[s];o.id in e&&n.push(o)}return n}}function td(i,t,e){const n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}const my=37297;let gy=0;function xy(i,t){const e=i.split(`
`),n=[],s=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let o=s;o<r;o++){const a=o+1;n.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return n.join(`
`)}const ed=new Xt;function _y(i){te._getMatrix(ed,te.workingColorSpace,i);const t=`mat3( ${ed.elements.map(e=>e.toFixed(4))} )`;switch(te.getTransfer(i)){case wa:return[t,"LinearTransferOETF"];case ae:return[t,"sRGBTransferOETF"];default:return Gt("WebGLProgram: Unsupported color space: ",i),[t,"LinearTransferOETF"]}}function nd(i,t,e){const n=i.getShaderParameter(t,i.COMPILE_STATUS),r=(i.getShaderInfoLog(t)||"").trim();if(n&&r==="")return"";const o=/ERROR: 0:(\d+)/.exec(r);if(o){const a=parseInt(o[1]);return e.toUpperCase()+`

`+r+`

`+xy(i.getShaderSource(t),a)}else return r}function vy(i,t){const e=_y(t);return[`vec4 ${i}( vec4 value ) {`,`	return ${e[1]}( vec4( value.rgb * ${e[0]}, value.a ) );`,"}"].join(`
`)}const yy={[cf]:"Linear",[hf]:"Reinhard",[uf]:"Cineon",[df]:"ACESFilmic",[pf]:"AgX",[mf]:"Neutral",[ff]:"Custom"};function Sy(i,t){const e=yy[t];return e===void 0?(Gt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const Wo=new N;function by(){te.getLuminanceCoefficients(Wo);const i=Wo.x.toFixed(4),t=Wo.y.toFixed(4),e=Wo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function My(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(zr).join(`
`)}function Ey(i){const t=[];for(const e in i){const n=i[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function Ay(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(t,s),o=r.name;let a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),e[o]={type:r.type,location:i.getAttribLocation(t,o),locationSize:a}}return e}function zr(i){return i!==""}function id(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function sd(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const wy=/^[ \t]*#include +<([\w\d./]+)>/gm;function Jc(i){return i.replace(wy,Cy)}const Ty=new Map;function Cy(i,t){let e=Kt[t];if(e===void 0){const n=Ty.get(t);if(n!==void 0)e=Kt[n],Gt('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Jc(e)}const Py=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function rd(i){return i.replace(Py,Ry)}function Ry(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function od(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}const Ly={[ma]:"SHADOWMAP_TYPE_PCF",[Or]:"SHADOWMAP_TYPE_VSM"};function Dy(i){return Ly[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Iy={[Es]:"ENVMAP_TYPE_CUBE",[ur]:"ENVMAP_TYPE_CUBE",[Ba]:"ENVMAP_TYPE_CUBE_UV"};function Ny(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Iy[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const By={[ur]:"ENVMAP_MODE_REFRACTION"};function Uy(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":By[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Fy={[lf]:"ENVMAP_BLENDING_MULTIPLY",[Mm]:"ENVMAP_BLENDING_MIX",[Em]:"ENVMAP_BLENDING_ADD"};function Oy(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Fy[i.combine]||"ENVMAP_BLENDING_NONE"}function ky(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function zy(i,t,e,n){const s=i.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=Dy(e),c=Ny(e),h=Uy(e),u=Oy(e),d=ky(e),f=My(e),g=Ey(r),x=s.createProgram();let m,p,y=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+p);const _=y+m+o,v=y+p+a,S=td(s,s.VERTEX_SHADER,_),A=td(s,s.FRAGMENT_SHADER,v);s.attachShader(x,S),s.attachShader(x,A),e.index0AttributeName!==void 0?s.bindAttribLocation(x,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function M(D){if(i.debug.checkShaderErrors){const I=s.getProgramInfoLog(x)||"",U=s.getShaderInfoLog(S)||"",F=s.getShaderInfoLog(A)||"",V=I.trim(),G=U.trim(),k=F.trim();let X=!0,ht=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(X=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,S,A);else{const st=nd(s,S,"vertex"),gt=nd(s,A,"fragment");ie("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
