...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:bi,depthTest:!1,depthWrite:!1})}function Yu(){return new si({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Fa(),fragmentShader:`
		...
		`,blending:bi,depthTest:!1,depthWrite:!1})}function qu(){return new si({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Fa(),fragmentShader:`
...
#define LOW_PRECISION`),t}const Ry={[fa]:"SHADOWMAP_TYPE_PCF",[Fr]:"SHADOWMAP_TYPE_VSM"};function Ly(i){return Ry[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Dy={[Es]:"ENVMAP_TYPE_CUBE",[hr]:"ENVMAP_TYPE_CUBE",[Ia]:"ENVMAP_TYPE_CUBE_UV"};function Iy(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Dy[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const Ny={[hr]:"ENVMAP_MODE_REFRACTION"};function By(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Ny[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Uy={[af]:"ENVMAP_BLENDING_MULTIPLY",[bm]:"ENVMAP_BLENDING_MIX",[Mm]:"ENVMAP_BLENDING_ADD"};function Fy(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Uy[i.combine]||"ENVMAP_BLENDING_NONE"}function Oy(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function ky(i,t,e,n){const s=i.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=Ly(e),c=Iy(e),h=By(e),u=Fy(e),d=Oy(e),f=by(e),g=My(r),x=s.createProgram();let m,p,y=e.glslVersion?"#version "+e.glslVersion+`
