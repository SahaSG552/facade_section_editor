...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Hn,depthTest:!1,depthWrite:!1})}function Vg(i,t,e){const n=new Float32Array(Mi),s=new N(0,1,0);return new Rn({name:"SphericalGaussianBlur",defines:{n:Mi,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Kr(),fragmentShader:`
		...
		`,blending:Hn,depthTest:!1,depthWrite:!1})}function _c(){return new Rn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Kr(),fragmentShader:`
		...
		`,blending:Hn,depthTest:!1,depthWrite:!1})}function vc(){return new Rn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Kr(),fragmentShader:`
