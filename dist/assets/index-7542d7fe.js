...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:bi,depthTest:!1,depthWrite:!1})}function Yu(){return new si({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ka(),fragmentShader:`
		...
		`,blending:bi,depthTest:!1,depthWrite:!1})}function qu(){return new si({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ka(),fragmentShader:`
